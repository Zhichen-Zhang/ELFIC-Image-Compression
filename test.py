...
def model_test():
    ...
    img_path = './kodim'
    ckpt = f'/home/fzus/zzc/Projects/Model_Weights/CA/PSNR/High/checkpoint_latest.pth'
...
def model_test_IDCA():
    ...
    _Bpp, _MS_SSIM, _PSNR, _encT, _decT = [], [], [], [], []
    img_path = './kodim'
    img_path = '/home/fzus/zzc/Data/CLIC/P_Valid'
    ckpt = f'/home/fzus/zzc/Projects/Model_Weights/CA/PSNR/High/checkpoint_latest.pth'
    codec = GainCA(rate_point=5)
    codec.eval()
    state_dict = torch.load(ckpt, map_location='cpu')["state_dict"]
